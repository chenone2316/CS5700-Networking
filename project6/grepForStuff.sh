...
do
tcpdump -Ar $file| grep -v 'TCP' | grep -v 'HTTP' | grep -v 'seq' > httpdata.txt
echo $file
...
grep -i "354407066557298" httpdata.txt | sort | uniq -c
grep -i "Shifu Xu" httpdata.txt | sort| uniq -c
grep -i "XXXXXXXXXX" httpdata.txt | sort | uniq -c
grep -i "878112146" httpdata.txt | sort | uniq -c
grep -i "XXXXXXXXXXXXX" httpdata.txt | sort | uniq -c 
